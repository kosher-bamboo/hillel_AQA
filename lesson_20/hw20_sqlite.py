...
enable_forein_key = """PRAGMA foreign_keys = ON;"""
...
connection = sqlite3.connect('hw20.db')
cursor = connection.cursor()

# cursor.execute(enable_forein_key)
...
cursor.execute('SELECT * FROM products p JOIN categories c ON p.category_id = c.category_id;')
